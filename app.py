...
# ----------------------------------------------------------------------
# 4. SESSION STATE INIT & RESET FUNCTION (FIXED ORDER!)
# ----------------------------------------------------------------------
...
# Reset function DEFINED FIRST before button calls it
def reset_game():
    st.session_state.snake = [[10, 10], [10, 11], [10, 12]]
    st.session_state.direction = "UP"
    st.session_state.food = [random.randint(2, 17), random.randint(2, 17)]
...
# Reset / Launch button (glitch style) - FUNCTION IS NOW DEFINED!
