...
# ----------------------------------------------------------------------
# 3. SIDEBAR – ENVIRONMENT & SETTINGS (FIX: Keys added here)
# ----------------------------------------------------------------------
st.sidebar.markdown("### 🎮 TERMINAL CONFIG")

# Added unique key "env_zone" to prevent DuplicateElementId error
...
# Added unique key "snake_col"
snake_color = st.sidebar.color_picker("SNAKE SKIN", "#00FF88", key="snake_col")

# Added unique key "base_spd"
...
# ----------------------------------------------------------------------
# 4. SESSION STATE INIT & RESET FUNCTION
# ----------------------------------------------------------------------
